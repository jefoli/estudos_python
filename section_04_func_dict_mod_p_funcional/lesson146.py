...
Todo generator é um iterator, porém o inverso não é verdade.
...
A generator expression não guarda todos os valores em memória, ela age como um loop 
que gera valores conforme necessário.

Ela "lembra" onde parou internamente e não precisa armazenar os valores gerados, 
diferente da lista!
"""
import sys
...
# por conta disso, podemos ver que a lista consome mais memória que generator, 
# por armazenar todos valores na memória.