...
strip - tem a função de cortar os espaços do começo e do fim da string
rstrip - tem a função de cortar os espaços da direita
lstrip - tem a função de cortar os espaços da esquerda
